      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-primary-foreground/80 leading-relaxed">
            Track expenses, manage budgets, and reach your financial goals with our AI-powered platform.
          </p>
          ...
          <div className="grid gap-4 pt-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-primary-foreground/90">Real-time transaction tracking</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-foreground/20">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <span className="text-primary-foreground/90">AI-powered spending analysis</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-foreground/20">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <span className="text-primary-foreground/90">Multi-currency support (MXN & USD)</span>
            </div>
          </div>
        </div>
